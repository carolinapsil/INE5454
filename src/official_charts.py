...
def extract_charts(page_url, week_number) -> DataFrame:
    ...
    for chart_row in chart_rows:
        ...
        song_name = capitalize_initials(chart_row.find_element(By.XPATH, './div[1]/div[2]/p/a[1]/span[2]').text)
        artist_name = capitalize_initials(chart_row.find_element(By.XPATH, './div[1]/div[2]/p/a[2]/span').text)
